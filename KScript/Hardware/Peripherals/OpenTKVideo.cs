...
namespace KScript.Hardware.Peripherals
{
    ...
    /// </summary>
    public class OpenTKVideo : GameWindow 
    {
        MonochromeDisplayAdapter adapter;

        public OpenTKVideo(int width, int height, string title, MonochromeDisplayAdapter displayAdapter)
            : base(width, height)
        {
        ...
        int GetFrame()
        {
            Bitmap raster = adapter.Rasterize();
